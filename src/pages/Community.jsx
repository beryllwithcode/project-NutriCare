    ...
    <div className="relative flex px-10 gap-14 lg:px-24 py-14 text-nutricare-green">
      <div className="w-screen">
        <div className="flex justify-between items-center pb-4 border-b-4">
          ...
          <Button className="bg-nutricare-green h-full">New Discussion</Button>
        </div>
        <div className="flex gap-4 my-4">
          ...
          {/* <Button
            variant="outlined"
            className="border-nutricare-green text-nutricare-green hover:bg-nutricare-green focus:bg-nutricare-green focus:text-white hover:text-white"
          >
            All
          </Button>
          <Button
            variant="outlined"
            className="border-nutricare-green text-nutricare-green hover:bg-nutricare-green hover:text-white"
          >
            Latest
          </Button>
          <Button
        ...
        <div className="flex flex-col gap-4">
          <div className="p-5 border-2 rounded-lg flex justify-between">
            <div>
            ...
            <div className="flex gap-4 text-nutricare-greenTuaFade">
              <div className="flex gap-2 items-center">
                <img src="/icons/chat-fade.svg" alt="" />
                <Typography>99</Typography>
              </div>
              <div className="flex gap-2 items-center">
                <img src="/icons/thumb-fade.svg" alt="" />
                <Typography>99</Typography>
              </div>
            </div>
          </div>
